...
import ui.methods.DeleteRecordsOlderThan2024;
import ui.methods.GetAllMedicalRecordsByPatient;
import ui.methods.SaveNewPrescription;
        ...
        if (loginResult.isRight()) {
            ...
            if (loggedIn) {
                ...
                while (!exit) {
                    System.out.println("""
                            MENU:
                            1. Show all patients - DONE
                            2. Show a patient by ID - DONE
                            3. Update a patient's information - DONE
                            4. Delete a patient's account - DONE
                            5. Save a new patient - DONE
                            ...
                            9. Show all the patients with their medicalRecords - DONE
                            10. Append a new prescription to a medical record - DONE
                            11. Delete all medical records older than year 2024 - DONE
                            12. Show the patient with most medical records - DONE
                            13. Show the date when most patients were admitted - DONE
                            14. Show the name and the number of medications of each patient - DONE
                            15. Exit
                            """);
